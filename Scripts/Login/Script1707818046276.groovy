...
Mobile.setText(findTestObject('Object Repository/login/android.widget.EditText (1)'), 'ruslan1', 0)

Mobile.setText(findTestObject('Object Repository/login/android.widget.EditText (2)'), 'P@ssw0rd', 0)
